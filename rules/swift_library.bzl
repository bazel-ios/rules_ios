...
# Note: this file was based on rules_swift. Longer term, we may consider calling
# swift_common.compile directly and get rid of the extra rule in our stack.
...
""",
        ...
        "_toolchain" : attr.label(
            default = Label("@build_bazel_rules_ios//:swift_toolchain"),
