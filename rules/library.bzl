...
def apple_library(
    ...
    if swift_sources:
        ...
        swift_kwargs = dicts.add(swift_kwargs, {"always_include_developer_search_paths": swift_always_include_developer_search_paths} if swift_always_include_developer_search_paths else {})
