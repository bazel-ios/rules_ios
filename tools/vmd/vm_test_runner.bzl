...
#
# Note: this is similar to rules_apple but allows passing a custom test runner
#
...
def _get_template_substitutions(*, device_type, os_version, simulator_creator, testrunner, runfiles):
